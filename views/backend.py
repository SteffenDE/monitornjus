...
from flask import url_for, render_template, request, Response, flash, make_response, Blueprint, current_app
		...
		def events():
			...
			while True:
				try:	
					...
					current_app.logger.warning('client disconnected, breaking')
					break
